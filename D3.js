...
if (NumeroBasso < NumeroAlto) {console.log(NumeroAlto); };
*/
...
if (Venti >= 20) {
  ...
  else if (Venti < 20 && Venti >= 15)   {
  console.log("Large");
  }
  else if (Venti < 15 && Venti >= 10) {
    console.log ("Medium")
  }
  else if (Venti < 10 && Venti >= 5) {
    console.log("Small");
  }
  else if (Venti < 5) {
    console.log("Tiny");
...
console.log(totaleConSpedizione); 
*/
